...
const HowItWorks = () => {
  ...
  return (
    <div className='py-16 px-6 max-w-7xl mx-auto'>
      <div className="text-5xl text-center text-accent mb-16 font-bold">
        How it works
      </div>
          ...
          {data.map((item, index) => (
            <div key={index} className="flex items-start gap-6 group">
              ...
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-white-800 mb-2 group-hover:text-accent transition-colors duration-300">
                  {item.title}
                </h3>
